...
def efficientnet_model(model_func=efficientnet_v2_s, model_name="efficientnet_v2_s", num_classes=2, weights='DEFAULT', progress=True):
...
if __name__=="__main__":
    model = efficientnet_model(efficientnet_v2_s, model_name="efficientnet_v2_s", num_classes=2, weights='DEFAULT', progress=True)
