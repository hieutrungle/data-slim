...
from .custom_layers import cus_layers, vector_quantizer, preprocessors
...
class VQCPVAE(basemodel.BaseModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.forward_mlp = cus_layers.ForwardMLP(self.conv_shape, name="ForwardMLP")
        self.vq_layer = vector_quantizer.VectorQuantizer(
            num_embeddings, latent_dim, name="vector_quantizer"
        )
        self.backward_mlp = cus_layers.InverseMLP(self.conv_shape, name="InverseMLP")
