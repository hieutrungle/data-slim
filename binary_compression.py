...
def main(args):
    ...
    # TODO: get mean and std from data or available file.
    stats = None
    if args.data_dir != "":
        try:
            stats = utils.get_netcdf_data_statistics(args.data_dir)
        ...
        try:
            stats = utils.get_netcdf_data_statistics(args.input_path)
